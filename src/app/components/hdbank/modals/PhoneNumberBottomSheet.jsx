...
import HDBankService from '../../../services/hdbankService';
		...
		<div className="w-full bg-white rounded-t-2xl max-h-[90vh] flex flex-col">
					...
					{ listSim.map( ( phone ) => {
						...
						return ( <div
							...
							className={ `relative p-4 rounded-xl border cursor-pointer transition-all ${ isSelected
								? 'border-2 border-[#DA2128] bg-white shadow-md'
			...
			<div className="p-4 bg-white border-t border-[#F1F1F1]">
				<button
					...
					className="w-full text-white font-semibold text-base rounded-lg font-inter disabled:opacity-50 disabled:cursor-not-allowed"
					style={{
