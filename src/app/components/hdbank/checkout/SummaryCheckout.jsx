...
const SummaryCheckout = () => {
	const t = useTranslations('hdbank.checkout.summary');
	...
	const feeShipping = useShipFeeHDBank(paramGH);
					...
					<>
						<div className="relative mb-2 flex items-center">
							...
							<input
								...
								className="font-inter text-[16px] text-[#1C1C1E] p-[12px_16px_12px_50px] border border-[#E5E5E5] rounded-[12px] focus:outline-none focus:border-[#DA2128] w-full bg-white"
						...
						<button
							...
							className="w-full py-3 px-4 bg-[linear-gradient(90deg,#DA2128_0.2%,#DA2128_50.07%,#F9A61C_75%,#F9C016_84.97%,#FFDD00_99.93%)] text-white font-inter font-semibold text-[14px] rounded-[12px] disabled:bg-[#E5E5E5] disabled:text-[#9E9E9E] disabled:bg-none disabled:cursor-not-allowed transition-colors"
						>
