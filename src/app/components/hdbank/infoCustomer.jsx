        ...
        <div className="flex flex-col gap-4 w-full mt-4 bg-white p-4 shadow-md rounded-lg">
            ...
            <div className="flex flex-col gap-2 border rounded-xl px-4 py-3">
                ...
                <input
                    ...
                    className={ `w-full text-sm font-inter placeholder-[#A1A1A1] focus:outline-none focus:ring-2 focus:ring-[#DA2128] focus:border-transparent transition-all ${ errors.email ? 'border-red-500' : 'border-[#E5E5E5]'
                        }` }
                />
            </div>
                { errors.data?.email && (
            ...
            { isSim == '0' && <div className="flex flex-col gap-2 border rounded-xl px-4 py-3">
                ...
                <input
                    ...
                    className={ `w-full text-sm font-inter placeholder-[#A1A1A1] focus:outline-none focus:ring-2 focus:ring-[#DA2128] focus:border-transparent transition-all ${ errors.phoneNumber ? 'border-red-500' : 'border-[#E5E5E5]'
                        }` }
                />
            </div> }
            ...
            <div className="flex flex-col gap-2 border rounded-xl px-4 py-3">
                ...
                <input
                    ...
                    className={ `w-full   text-sm font-inter placeholder-[#A1A1A1] focus:outline-none focus:ring-2 focus:ring-[#DA2128] focus:border-transparent transition-all ${ errors.fullName ? 'border-red-500' : 'border-[#E5E5E5]'
                        }` }
                />
            </div>
