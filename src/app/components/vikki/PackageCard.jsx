...
import { showActivateSimModal } from "../modals/vikki/modalActivateSim";
import { Button } from "../ui/Button";
import clsx from "clsx";

const PackageCard = ({ pack, isHighlighted = false, className }) => {
  const { openCheckPackageModal, openPackDetailModal } = usePackageViki();
    ...
    >
      ...
      <div className="flex justify-between items-start border-b border-[#e5e5eacb] py-3">
        <div className="flex  items-start gap-2">
          ...
          {hasDiscount && (
            <div className="bg-[#D2008C] text-white text-[12px] font-medium px-1.5 py-0.5 rounded">
      ...
      <div className="flex items-center justify-between mt-auto gap-1">
        <div className="flex flex-col">
          <div className="flex items-baseline gap-1">
            <span className="text-[#D2008C] text-[16px] font-bold leading-[24px]">
