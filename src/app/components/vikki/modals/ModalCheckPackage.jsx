...
const ModalCheckPackage = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await PackageService.checkPackageRegisterVikki(params);
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl border ${errors.msisdn ? "border-red-500" : "border-gray-200"} focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all`}
              disabled={true}
            />
            {errors.msisdn && (
              ...
              if (index === 1) {
                return (
                  <span
                    ...
                    onClick={() => {
                      router.push("/app-vikki/sim-data");
                      close();
                    }}
                  >
                    {line}
