	...
	return (
		<div className="flex flex-col gap-4 w-full mt-4">
			...
			<div className="flex items-center gap-2 w-full">
				{/* SIM Icon */ }
				<div className="flex items-center justify-center w-10 h-10 bg-[#DA2128] rounded-xl p-1">
				...
				<button
					...
					className="px-4 py-2.5 bg-[rgba(218,33,40,0.1)] text-[#DA2128] text-sm font-semibold rounded-full hover:bg-[rgba(218,33,40,0.2)] transition-colors"
				>
					Chọn số khác
				</button>
			</div>
			...
			{ isSim == '0' ? (
				...
				<p className="text-xs text-[#5C5C5C] font-inter">
					...
					<span className="text-[#DA2128] cursor-pointer" onClick={ showDevicesEsimHDBank }> Xem danh sách thiết bị</span>
				</p>
			) }
		</div>
		</div >
