...
const QuickActions = () => {
  ...
  return (
    <div className="flex justify-center gap-10 w-full py-4">
        <div className="flex flex-col items-center gap-2 cursor-pointer " onClick={() => router.push('/hdbank-app-v2/sim-data')}>
        ...
        <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={() => router.push('/hdbank-app-v2/package')}>
        ...
        {/* <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={() => router.push('/hdbank-app-v2/topup')}>
        ...
        <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={() => router.push('/hdbank-app-v2/travel-esim')}>
