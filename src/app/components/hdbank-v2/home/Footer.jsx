...
const Footer = () => {
  ...
  const getActiveTab = () => {
    if (pathname.includes('/hdbank-app-v2/profile')) return 'profile';
    if (pathname.includes('/hdbank-app-v2/support')) return 'support';
    return 'home';
  };
  ...
  const tabs = [
    { id: 'home', label: t('home'), icon: HomeIcon, activeIcon: HomeIconSolid, href: '/hdbank-app-v2' },
    { id: 'support', label: t('support'), icon: QuestionMarkCircleIcon, activeIcon: QuestionMarkCircleIconSolid, href: '/hdbank-app-v2/support' },
    { id: 'profile', label: t('profile'), icon: UserCircleIcon, activeIcon: UserCircleIconSolid, href: '/hdbank-app-v2/profile' },
  ];
