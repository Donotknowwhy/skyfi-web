...
const PackageUsageCard = ({
  ...
  const goPageInfoPack = (code) => {
    ...
    router.push("/hdbank-app-v2/sim-info");
  };
  ...
  return (
    <div className="bg-white rounded-xl shadow-[0px_3px_8px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.05)] py-4 flex flex-col gap-3 mx-0.5 my-1">
      ...
      >
        ...
        <div className="relative w-[140px] h-[140px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-sm font-bold text-[#DA2128]">
      ...
      <div className="flex items-center gap-2 px-4 pt-3 border-t border-[#F4F4F4]">
        <button
          className="flex items-center gap-2 text-sm font-semibold text-[#DA2128]"
          onClick={() => router.push("/hdbank-app-v2/package")}
        >
          <svg
            width="16"
            height="16"
          ...
          <>
            ...
            >
              <span className="text-sm font-semibold text-[#333333]">
                {t("renewWithVikki").replace(/Vikki/gi, "HDBank")}
              </span>
              <div
                className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
                  isAutoBillActive ? "bg-[#DA2128]" : "bg-[#D8D8D8]"
                }`}
              >
                <span
