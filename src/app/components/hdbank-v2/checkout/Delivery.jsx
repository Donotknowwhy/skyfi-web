...
const Delivery = () => {
    ...
    const t = useTranslations('hdbank.checkout.delivery');
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1 border rounded-xl px-4 py-3">
                    ...
                    <input
                        ...
                        className={ `w-full text-[16px] font-inter text-[#333] focus:outline-none focus:border-[#DA2128] transition-all ${ errors.delivery_address ? 'border-red-500' : 'border-[#DDDDDD]' }` }
                    />
