                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col gap-2 border rounded-xl px-4 py-3">
                        ...
                        <input
                            ...
                            className={ `w-full text-sm font-inter placeholder-[#A1A1A1] focus:outline-none focus:ring-2 focus:ring-[#DA2128] focus:border-transparent transition-all ${ errors.data?.deliveryAddress ? 'border-red-500' : 'border-[#E5E5E5]' }` }
                        />
                    </div>
