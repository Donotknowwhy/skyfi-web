...
const ShipAddress = ({ onSelect, initialCityId, initialDistrictId, initialWardId }) => {
	const t = useTranslations('hdbank.shipAddress');
	...
	return (
		<div className="flex flex-col gap-1 w-full border rounded-xl px-3 py-2 border-[#F1F1F1] relative">
			...
			<button
				...
				className="flex items-center justify-between w-full  bg-white   rounded-xl hover:border-[#DA2128] transition-colors"
			>
			...
			<div className='absolute top-1/2 -translate-y-1/2 right-2'>
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M6 9L12 15L18 9" stroke="#DA2128" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
				</svg>
			</div>
		</div>
	);
