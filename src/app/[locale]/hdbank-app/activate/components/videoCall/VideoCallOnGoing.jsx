...
const VideoCallOnGoing = () => {
    const t = useTranslations('hdbank.videoCall.ongoing');
    const refRoom = useRef(null);
    const apiRef = useRef(null);
    const { jitsiData, stopCall } = useActivateHDBank();
                    ...
                    {permissionError ? (
                        <>
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-[#DA2128] text-white rounded-lg hover:bg-[#B71C22] transition-colors"
                            >
                                {t('retry')}
                            </button>
