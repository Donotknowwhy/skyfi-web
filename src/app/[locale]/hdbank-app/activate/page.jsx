...
import { InfoActivateVikki, InputActivateVikki, ScanQRVikki, SignActivateVikki, VideoCallVikki } from "./components";
...
const ContentData = () => {
    const { method } = useActivateHDBank();
