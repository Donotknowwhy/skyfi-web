    ...
    <div className="min-h-[100dvh] flex flex-col bg-gradient-to-b from-[#FFF9F5] via-[#FFF3EA] to-white">
      ...
      <div className="flex-1 bg-white rounded-t-[20px] px-4 mt-2">
        ...
        <MenuItem
          ...
          onClick={() => router.push("/hdbank-app/manager-esim")}
        />
        ...
        <MenuItem
          ...
          title={t("accountInfo")}
          onClick={() =>
            checkLogin(() => router.push("/hdbank-app/profile/detail"))
          }
        />
        ...
        <MenuItem
          ...
          onClick={() =>
            checkLogin(() =>
              router.push("/hdbank-app/profile/subscriber-history"),
            )
          }
        />
        ...
        <MenuItem
          ...
          title={t("activateSim")}
          onClick={() =>
            checkOverNumber(() => router.push("/hdbank-app/activate"))
          }
        />
        ...
        <MenuItem
          ...
          onClick={() => router.push("/hdbank-app/profile/terms")}
        />
      </div>
