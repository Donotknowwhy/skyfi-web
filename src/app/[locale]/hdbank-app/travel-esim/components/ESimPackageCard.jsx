...
import { showCountriesModal } from '@/app/components/hdbank/modals/CountriesListModal';
...
export default function ESimPackageCard({
  ...
  const t = useTranslations('hdbank.travelEsim.packageCard');
  ...
  const handleBuyClick = async (isCountryListClickable) => {
    ...
    router.push(`/hdbank-app/travel-esim/detail`);
    ...
    <div className="bg-white flex flex-col rounded-xl shadow-[0px_4px_16px_0px_rgba(144,118,170,0.08),0px_0px_1px_0px_rgba(0,0,0,0.15),0px_1px_1px_0px_rgba(0,0,0,0.03)] overflow-hidden relative isolate"  >
      ...
      <div className="flex flex-col px-4 py-2">
        ...
        <div className="flex items-center justify-between py-1">
          ...
          <p className="text-[13px] font-semibold text-[#DA2128] leading-[24px] text-right underline cursor-pointer" onClick={() =>handleBuyClick(isCountryListClickable)} >
            { getCountryList() }
          </p>
        </div>
        ...
        <div className="flex items-center justify-between py-1">
          ...
          <div className="flex items-baseline gap-0.5">
            <p className="text-sm font-semibold text-[#DA2128] leading-[20px] tracking-[-0.1px]">
              {new Intl.NumberFormat('vi-VN').format(price)}
            </p>
            <p className="text-[12px] font-normal text-[#DA2128] leading-[16px] tracking-[-0.1px]">
              {currency}
            </p>
          </div>
        </div>
