...
import PackageItem from "@/app/components/hdbank/sim-data/PackageItem";
...
import HDBankEventBanner from "@/app/components/hdbank/sim-data/HDBankEventBanner";
        ...
        <div className="bg-white rounded-[16px] p-4 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-3 ">
              <div className="w-10 h-10 bg-[#F2F2F7] rounded-full flex items-center justify-center text-[#DA2128] font-bold text-lg">
                <svg
                  width="40"
                  height="40"
                  viewBox="0 0 40 40"
