...
const ProfilePage = () => {
  const t = useTranslations("hdbank.profile");
    ...
    <div className="min-h-[100dvh] flex flex-col bg-gradient-to-b from-[#FFF9F5] via-[#FFF3EA] to-white">
      ...
      <div className="flex-1 bg-white rounded-t-[20px] px-4 mt-2">
        ...
        <MenuItem
          ...
          onClick={() => router.push("/hdbank-app-v2/manager-esim")}
        />
        ...
        <MenuItem
          ...
          title={t("accountInfo")}
          onClick={() =>
            checkLogin(() => router.push("/hdbank-app-v2/profile/detail"))
          }
        />
        ...
        <MenuItem
          ...
          onClick={() =>
            checkLogin(() =>
              router.push("/hdbank-app-v2/profile/subscriber-history"),
            )
          }
        />
        ...
        <MenuItem
          ...
          title={t("activateSim")}
          onClick={() =>
            checkOverNumber(() => router.push("/hdbank-app-v2/activate"))
          }
        />
        ...
        <MenuItem
          ...
          trailing={
            <div className="flex items-center gap-2">
              <span className="text-xs font-semibold text-[#DA2128] bg-[#DA2128]/10 px-4 py-2 rounded-full">
                1900 6605
              </span>
            </div>
          }
        ...
        <MenuItem
          ...
          onClick={() => router.push("/hdbank-app-v2/profile/terms")}
        />
      </div>
