...
export default function HDBankCartPage() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-be-vietnam-pro text-sm leading-[20px] text-[#5C5C5C] mt-1">
        ...
        {cartItems.length > 0 ? (
          <div className="bg-white rounded-2xl overflow-hidden">
            ...
            <div className="flex justify-between items-center px-4 py-3 border-b border-[#F1F1F1]">
              <p className="flex-1 font-be-vietnam-pro font-semibold text-sm text-[#333333]">
                {t("productHeader")}
              </p>
              <p className="flex-1 font-be-vietnam-pro font-semibold text-sm text-[#333333] text-right">
                {t("priceHeader")}
              </p>
            </div>
            ...
            <div className="px-4 pt-4 pb-4">
              ...
              <div className="flex justify-between py-2 border-b border-[#F1F1F1]">
                <span className="font-be-vietnam-pro text-sm text-[#333333]">
                  {t("itemCount", { count: totalQuantity })}
                </span>
                <span className="font-be-vietnam-pro font-medium text-sm text-[#333333]">
          ...
          <div className="flex flex-col items-center gap-10 py-8">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="font-be-vietnam-pro text-sm leading-[20px] text-center text-[#5C5C5C] w-[271px]">
                {t("emptyDescription")}
              </p>
            </div>
            ...
            {/* Button */}
            <button
              onClick={() => router.push("/hdbank-app-v2/sim-data")}
  ...
  return (
    <div className="flex gap-3 items-start py-2 border-b border-[#F1F1F1] last:border-0">
      ...
      <div className="flex-1 min-w-0 ">
        <p className="font-be-vietnam-pro font-semibold text-sm leading-[20px] text-[#333333]">
          {item.product_name}
        </p>
        <p className="font-be-vietnam-pro text-sm leading-[20px] text-[#5C5C5C]">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        <div className="flex flex-col items-end">
          ...
          {item.originalPrice && item.originalPrice > item.total_price && (
            <span className="font-be-vietnam-pro text-sm text-[#8A8A8A] line-through">
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center bg-[#DA2128] rounded-md hover:bg-[#A0006B] transition-colors"
        >
          <DeleteIcon />
        </button>
      </div>
