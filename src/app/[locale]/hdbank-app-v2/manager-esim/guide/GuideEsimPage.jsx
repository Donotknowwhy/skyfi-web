...
const StepItem = ({ number, text }) => (
  <div className="flex gap-3 mb-4">
    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#DA2128] flex items-center justify-center text-white text-xs font-bold mt-0.5">
      {number}
    </div>
          ...
          <div className="flex gap-3 mb-6">
            <button
              className={`flex-1 py-2.5 px-4 rounded-full text-sm font-semibold border transition-colors ${
                methodTab === "qr"
                  ? "bg-white text-[#DA2128] border-[#DA2128]"
