...
import Delivery from '@/app/components/hdbank-v2/checkout/Delivery';
import InfoClient from '@/app/components/hdbank-v2/checkout/InfoClient';
import ListProduct from '@/app/components/hdbank-v2/checkout/ListProduct';
import SummaryCheckout from '@/app/components/hdbank-v2/checkout/SummaryCheckout';
    ...
    const sendMessage = (code) => {
        if (typeof window !== 'undefined') {
            const message = {
                ...
                "bill_id": code,
                "bill_type": "online",
                "url_callback": `${getCallbackBaseUrl()}/hdbank-app-v2/checkout/result?orderId=${code}`
            }
    ...
    const handleSubmit = async (data) => {
        try {
            ...
            if (res.order_number && res.total_amount === 0) {
                ...
                const orderDetailUrl = `/hdbank-app-v2/checkout/result?orderId=${res.order_number}`;
                setTimeout(() => {
