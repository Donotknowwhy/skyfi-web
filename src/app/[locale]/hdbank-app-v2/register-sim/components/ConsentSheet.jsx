    ...
    <div className="fixed inset-0 z-[100] flex flex-col justify-end">
      ...
      <div className="relative w-full max-h-[92dvh] flex flex-col rounded-t-3xl bg-white animate-[slideUp_.25s_ease-out]">
        ...
        <div className="flex-1 overflow-y-auto px-5 pt-3 pb-4">
          {/* Info icon */}
          <div className="flex h-[72px] w-[72px] items-center justify-center rounded-full border-[3px] border-[#ED1B2F]">
            <svg width="20" height="40" viewBox="0 0 20 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="10" cy="7" r="4" fill="#F9A61C" />
              <rect x="6" y="15" width="8" height="20" rx="4" fill="#F9A61C" />
            </svg>
          </div>

          <h2 className="mt-5 text-[28px] font-bold leading-tight text-[#0E0E0F]">
            {t("consentProvidedBy")} {t("consentProvidedByBold")}
          </h2>
          ...
          <div className="mt-5 flex items-start gap-3">
            ...
            <p className="flex-1 text-sm leading-relaxed text-[#0E0E0F]">
              ...
              <span className="font-bold text-[#DA2128] underline">HDBank</span>{" "}
              {t("and")}{" "}
              <span className="font-bold text-[#DA2128] underline">SkyFi</span>.
            </p>
          </div>
          ...
          <button
            ...
            style={
              allChecked
                ? {
                    background:
                      "linear-gradient(90deg, #ED1B2F 0%, #F9A61C 100%)",
                  }
                : undefined
            }
          >
