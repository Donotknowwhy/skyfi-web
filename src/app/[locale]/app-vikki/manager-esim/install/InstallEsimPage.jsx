      ...
      <div className="px-4 pb-8 flex flex-col gap-4 mt-2">
        ...
        <div className="bg-white rounded-[20px] p-6 flex flex-col items-center shadow-sm">
          <div className="bg-white p-2 mb-4">
            <QRCodeSVG value={esimData.qrcode || "https://vikki.vn"} size={220} />
          </div>
          
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg font-bold text-[#333333]">{t("qrInstallTitle")}</span>
            <button onClick={downloadQR} className="text-[#D2008C] p-1">
          ...
          <button 
            onClick={() => router.push("/app-vikki/manager-esim/guide")}
            className="text-sm font-semibold text-[#D2008C] underline decoration-[#D2008C] underline-offset-4"
          >
