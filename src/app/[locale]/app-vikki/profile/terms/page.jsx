...
const TermsPage = () => {
  const t = useTranslations('vikki.profile.terms');
    ...
    <div className="min-h-[100dvh] flex flex-col bg-gradient-to-b from-[#E8E5FA] via-[#F3E8F4] to-white">
      ...
      <div className="flex-1 bg-white rounded-t-[20px] px-4 mt-2">
        ...
        <MenuItem
          ...
          onClick={() => router.push('/app-vikki/profile/sample-contact')}
        />
        ...
        <MenuItem
          ...
          onClick={() => router.push('/app-vikki/profile/service-quality-management')}
        />
      </div>
