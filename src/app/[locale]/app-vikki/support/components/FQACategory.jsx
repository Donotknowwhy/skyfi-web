...
const FAQCategory = ({ questions, isShowDefault = false }) => {
  ...
  return (
    <div className=" bg-neutral-100 p-4  rounded-[16px] mb-4">
      ...
      >
        <h2 className=" font-semibold text-[#333333] flex-1 text-start">
        ...
        >
          <path
            d="M10.2204 13.23L14.0476 9.08593C14.2864 8.82734 14.1417 8.33301 13.8271 8.33301H6.17272C5.85819 8.33301 5.71343 8.82734 5.95224 9.08593L9.77944 13.23C9.90631 13.3674 10.0935 13.3674 10.2204 13.23Z"
            fill="#181818"
          />
        </svg>
      </button>
