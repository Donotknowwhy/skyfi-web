    ...
    <div className="relative w-[180px] h-[180px] mx-auto">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-xl font-bold text-[rgba(50,52,56,0.61)]">
          <span className="text-[#0000FF]">{dataRemainGB}GB</span>/{totalData}GB
        </span>
      </div>
    </div>
  );
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="relative h-2 bg-[rgba(50,52,56,0.16)] rounded-full overflow-hidden">
            <div
              className="absolute top-0 left-0 h-full bg-[#0000FF] rounded-full transition-all"
...
const SimInfoPage = () => {
  const t = useTranslations("vikki.simInfo");
  ...
  // console.log("callMinutes", callMinutes);
  // console.log("sms", sms);
  // console.log("remainVoice", remainVoice);
  // console.log("totalVoice", totalVoice);
  // console.log("remainSms", remainSms);
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#E8E5FA] via-[#F3E8F4] to-white">
        <div className="w-8 h-8 border-3 border-[#0000FF] border-t-transparent rounded-full animate-spin" />
      </div>
    );
  }
    ...
    <div className="min-h-[100dvh] flex flex-col bg-gradient-to-b from-[#E8E5FA] via-[#F3E8F4] to-white">
      ...
      <div className="flex flex-col gap-2 px-4 mt-6 pb-24">
        ...
        <div className="flex items-center justify-between py-2">
          ...
          <button
            className="text-sm font-semibold text-[#0000EA]"
