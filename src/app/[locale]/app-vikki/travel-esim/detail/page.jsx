...
const InfoCircleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 13.3333V10M10 6.66667H10.0083M17.5 10C17.5 14.1421 14.1421 17.5 10 17.5C5.85786 17.5 2.5 14.1421 2.5 10C2.5 5.85786 5.85786 2.5 10 2.5C14.1421 2.5 17.5 5.85786 17.5 10Z" stroke="#0000FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export default function ESimDetailPage() {
  const t = useTranslations('vikki.travelEsim.packageDetail');
  const tCard = useTranslations('vikki.travelEsim.packageCard');
  ...
  const handleBuyNow =  () => {
    ...
    setSims([convertSimTravel(packageData, quantity)]);
     router.push( `/${locale}/app-vikki/checkout/payment` );

  };

  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E8E5FA] via-[#F3E8F4] via-[#FCF1EE] via-[#FEF8F4] via-[#FFFDFC] to-white pb-40">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-white">
        ...
        <div className=" flex items-center justify-between p-4">
          ...
          <h1 className="text-[14px] font-semibold text-[#0C0C0E]">{t('title')}</h1>
      ...
      <div className="px-4 py-4 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-[0px_1px_1px_0px_rgba(0,0,0,0.03),0px_0px_1px_0px_rgba(0,0,0,0.15),0px_4px_16px_0px_rgba(144,118,170,0.08)] p-4 space-y-1">
            <h3 className="text-[14px] font-semibold text-[#0C0C0E] mb-4">{t('yourPackage')}</h3>
            ...
            <div className="flex items-center justify-between py-1">
              ...
              <div className="flex items-baseline gap-0.5">
                <p className="text-[14px] font-semibold text-[#D2008C] leading-[20px]">
                  {new Intl.NumberFormat('vi-VN').format(price)}
                </p>
                <p className="text-[12px] font-normal text-[#D2008C] leading-[16px]">
                  {currency}
                </p>
              </div>
            </div>
        ...
        {/* Description Section */}
        <div className="space-y-4">
          <h2 className="text-[16px] font-semibold text-[#0000FF]">{t('description')}</h2>
          ...
          <div className="bg-white rounded-xl shadow-[0px_1px_1px_0px_rgba(0,0,0,0.03),0px_0px_1px_0px_rgba(0,0,0,0.15),0px_4px_16px_0px_rgba(144,118,170,0.08)] p-4 divide-y divide-[#F3F4F6]">
            ...
            <div className="flex items-center justify-between py-3">
              ...
              <p className="text-[13px] font-semibold text-[#0000FF] underline">{nameRegion}</p>
            </div>
        ...
        <div className="bg-[#FFF5E9] rounded-xl p-3 flex gap-4">
          ...
          <p className="text-[12px] font-normal text-[#0C0C0E] leading-[16px]">
            {t('deviceWarning')}
            <span className='text-[#D2008C] underline cursor-pointer' onClick={showDevicesEsimVikki}>
              {t('ViewDevices')}
            </span>
          </p>
        </div>
