...
import { showModalChangeSimViki } from "@/app/components/vikki/modals/showModalChangeSimViki";
import Header from "@/app/components/vikki/sim-data/Header";
import PackageItem from "@/app/components/vikki/sim-data/PackageItem";
import Tooltip from "@/app/components/vikki/Tooltip";
...
import VikkiEventBanner from "@/app/components/vikki/sim-data/VikkiEventBanner";
import { useForm } from "react-hook-form";

const SimDataPage = () => {
  const t = useTranslations("vikki.simData");
  const tTravelEsim = useTranslations("vikki.travelEsim");
    ...
    >
      ...
      <main className="flex-1 p-4 space-y-4 pb-48">
        ...
        <div className="bg-white rounded-[16px] p-4 shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)]">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-3 ">
              <div className="w-10 h-10 bg-[#F2F2F7] rounded-full flex items-center justify-center text-[#0057FF] font-bold text-lg">
                <svg
                  width="40"
                  height="40"
                  viewBox="0 0 40 40"
                ...
                >
                  ...
                  <g mask="url(#mask0_359_111503)">
                    <path
                      d="M32.9977 10.0715H6.84131V29.9277H32.9977V10.0715Z"
                      fill="white"
                    />
                  </g>
                </svg>
            ...
            <button
              onClick={() => showModalChangeSimViki({ onChange: changeSim })}
              className="text-[#0057FF] text-[13px]    font-bold"
            >
              {t("selectOther")}
            </button>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-4">
                ...
                >
                  <div
                    className={`w-5 h-5 rounded-full border flex items-center justify-center ${simTypeSelect === "USIM" ? "border-[#0057FF]" : "border-[#A1A1A1]"}`}
                  >
                    {simTypeSelect === "USIM" && (
                      <div className="w-2.5 h-2.5 bg-[#0057FF] rounded-full" />
                    )}
                  </div>
                ...
                >
                  <div
                    className={`w-5 h-5 rounded-full border flex items-center justify-center ${simTypeSelect === "ESIM" ? "border-[#0057FF]" : "border-[#A1A1A1]"}`}
                  >
                    {simTypeSelect === "ESIM" && (
                      <div className="w-2.5 h-2.5 bg-[#0057FF] rounded-full" />
                    )}
        ...
        <div className="flex flex-col gap-3">
          {!isVikki_event && isVikki_popup && <VikkiEventBanner />}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-[16px] p-4 pb-8 z-40 shadow-[0px_-4px_10px_0px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            className="flex-1 !rounded-full !border-[#E5E5E5] !text-[#0E0E0F] font-semibold text-[14px]"
          ...
          <Button
            variant="normal"
            className="flex-1 !rounded-full font-semibold text-[14px]   "
